    ...
    <AnimatedPage>
      <AnimatePresence mode='wait'>
        {selected ? (
          ...
          >
            <ProjectViewer data={selected} onBack={() => setSelected(null)} />
          </motion.div>
        ) : (
          <motion.div
            key='menu'
          ...
          >
            <Block>
              <div className='works__header'>
                <span className='works__label'>Index / 04 fields</span>
                <h1 className='works__title'>Fields of Practice</h1>
                <p className='works__intro'>
                  Software, systems, image, interaction, and computational form.
                </p>
              </div>
              ...
              <div className='works__list'>
                {categories.map(({ label, data }, i) => (
                  ...
                  >
                    ...
                    <span className='works__item-copy'>
                      <h2 className='works__item-title'>{label}</h2>
                      <span className='works__item-desc'>{data.category.description}</span>
                    </span>
                  </motion.button>
                ))}
              </div>
